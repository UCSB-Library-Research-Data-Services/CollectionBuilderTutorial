...
![GitHub Pages settings](_static/githubPages.png){width="600"}

- After a few moments, your exhibit will be published and you can access it at the URL provided in the "GitHub Pages" section.

![Deploying exhibit](_static/deploying.png){width="400"}

![Exhibit URL](_static/exhibitURL.png){width="400"}

![Exhibit homepage](_static/exhibitHomepage.png){width="600"}
