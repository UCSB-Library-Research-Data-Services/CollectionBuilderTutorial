...
![Upload metadata CSV file](_static/uploadMetadata.png){width="600"}

- Add and commit your changes to the repository:

![Stage changes](_static/satageChanges.png){width="600"}

![Add a commit message](_static/commitMessage.png){width="600"}

![Commit changes](_static/commitChanges.png){width="600"}
